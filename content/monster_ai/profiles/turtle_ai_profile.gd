...
func decide_next_action(monster_index: int, battle_room, available_dice: Array[Dice], dice_value_penalty: int = 0) -> MonsterAiDecision:
	...
	if turtle_durability != null and BattleAbilityRuntime.can_use_ability_with_dice(turtle_durability, available_dice, true, dice_value_penalty):
	...
	if turtle_defense != null and BattleAbilityRuntime.can_use_ability_with_dice(turtle_defense, available_dice, true, dice_value_penalty):
	...
	if turtle_bite != null and BattleAbilityRuntime.can_use_ability_with_dice(turtle_bite, available_dice, true, dice_value_penalty):
